...
BEGIN
    ...
    SELECT POSITION_BASIC_SALARY+ TOTAL_ALLOWANCE +TOTAL_INCENTIVE-TOTAL_DEDUCTION FROM(
    SELECT b.EMPLOYEE_ID, POSITION_BASIC_SALARY, DECODE(TOTAL_ALLOWANCE,null,0,TOTAL_ALLOWANCE) as TOTAL_ALLOWANCE,
...
--TRG ATTENDENCE LATE 
CREATE OR REPLACE TRIGGER TGR_LATE
    BEFORE
